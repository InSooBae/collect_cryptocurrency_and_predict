...
def init_mod():
    ...
    binance_api_key = "mXJ5H1lEPxTuCcZMmKw93qTOI1meREVLkoGBrU5fletm67rSRAB6L42b5tUrmwem"
    binance_api_secret = "iL2ovRP3Od8lDHPRagDsjfnLcxg1zJ0jG8KWG8l7NISg54FuSN1L1aR80Vk7l8IL"
    ...
    while True:
        ...
        if not simulate:
            ...
            if not os.path.exists(output_filename):
                data_df.to_csv(output_filename, mode='w', encoding='utf-8')
            else:
                data_df.to_csv(output_filename, mode='a', encoding='utf-8', header=False)
